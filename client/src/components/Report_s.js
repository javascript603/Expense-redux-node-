...
export default class Roport extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            products: this.props.productArray.products
        }
    }
    ...
    componentWillReceiveProps(nextProps) {
        ...
        this.setState({ reports: nextProps.reports, products: nextProps.productArray.products })
    }
    ...
    deleteData = (e) => {
        ...
        this.props.mappedReportDelete(data, this.props.mappedproductGetList);
    ...
    filteronSubmit = (e) => {
        ...
        this.props.mappedproductFilterResult(data);
    }
    ...
    getSelectedRows = () => {
        ...
        let data = products.filter((product) => {
            return selectedRows.indexOf(product._id) !== -1
        });
        return data;
    }
    ...
    handleMainTableRowSelect = (row, isSelected, e) => {
        this.setState({ selectData: row })
        if (e.target.getAttribute("name") === "detail") {
            browserHistory.push(`/report_s/${row._id}`);
